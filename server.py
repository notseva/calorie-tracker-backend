                                                                                ...
                                                                                max_tokens=500,
                                                                                            messages=[{'role':'user','content':[
                                                                                                            {'type':'image','source':{'type':'base64','media_type':mt,'data':img}},
                                                                                                                            {'type':'text','text':'Nutrition expert. Identify food precisely. Return ONLY JSON: {"food":"Russian name","ingredients":"list","portion":"~Xg","kcal":0,"protein":0,"fat":0,"carbs":0,"confidence":95}'}
                                                                                                                                        ]}]
                                                                                                                                                )
